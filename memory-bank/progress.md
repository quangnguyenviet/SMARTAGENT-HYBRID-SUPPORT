...
- **Thiết Kế**:
  - Vẽ luồng dữ liệu (Data Flow) chi tiết cho quá trình chuyển giao (Handover).
  - Lên thiết kế giao diện Mockup/Wireframe cho Sales-Centric Dashboard.
- **Phát Triển (Development)**:
  - Khởi tạo Base Project (Backend/Frontend).
